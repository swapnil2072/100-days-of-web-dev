...
const secondButtonElemet = document.getElementById("change-bg-btn");
...
// secondButtonElemet.addEventListener("click", changeBackgroundColor);
...
function changeBackgroundColor(event) {
  thirdParagraphElement.style.backgroundColor = "blue";
}
firstButtonElement.addEventListener("click", removeParagraph);
secondButtonElemet.addEventListener("click", changeBackgroundColor);
...
function changeBackgroundColor(event){
    thirdParagraphElement.classList.add('blue-bg')
}